...
import updateSiteMap from "./utils.js/schedules/update-sitemap.js";
...
if (process.env.NODE_ENV == "development") {
  ...
  const options = {
    ...
    ca: fs.readFileSync(
      "/etc/letsencrypt/live/purplevery23.cafe24.com/fullchain.pem"
    ),
    key: fs.readFileSync(
      "/etc/letsencrypt/live/purplevery23.cafe24.com/privkey.pem"
    ),
    cert: fs.readFileSync(
      "/etc/letsencrypt/live/purplevery23.cafe24.com/cert.pem"
    ),
  };
